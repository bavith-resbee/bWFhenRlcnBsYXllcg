...
class YouTubeOverlay(context: Context, private val attrs: AttributeSet?) :
    ...
    private var secondsViewLeft: SecondsView
    ...
    init {
        ...
        secondsViewLeft = findViewById(R.id.seconds_view_left)
    ...
    var textAppearance: Int = 0
        private set(value) {
            ...
            TextViewCompat.setTextAppearance(secondsViewLeft.textView, value)
            field = value
        }
    ...
    override fun onDoubleTapProgressUp(posX: Float, posY: Float) {
        ...
        if (shouldForward == true) {
            secondsView = findViewById(R.id.seconds_view);
        } else if (shouldForward == false) {
            secondsView = findViewById(R.id.seconds_view_left)
        }
    ...
    private fun changeConstraints1(forward: Boolean) {
