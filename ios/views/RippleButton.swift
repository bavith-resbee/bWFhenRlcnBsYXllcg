...
open class RippleButton: UIButton {
    ...
    @IBInspectable open var ripplePercent: Float = 1.2 {
        didSet {
            setupRippleView()
        }
    }

    @IBInspectable open var rippleColor: UIColor = UIColor(white: 0.8, alpha: 0.5) {
        didSet {
    ...
    @IBInspectable open var rippleBackgroundColor: UIColor = UIColor(white: 0.95, alpha: 1) {
        didSet {
            rippleBackgroundView.backgroundColor = .clear
        }
    }
    ...
    @IBInspectable open var rippleOverBounds: Bool = true
